      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Stats Section - No overlap, just negative margin
            Transform.translate(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: _buildStatCard("118", "Total Sales", const Color(0xFFFF7043)),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _buildStatCard("\$2.8K", "Revenue", const Color(0xFF66BB6A)),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: _buildStatCard("3", "Active", Colors.black87),
                    ),
                  ],
                ),
              ),
